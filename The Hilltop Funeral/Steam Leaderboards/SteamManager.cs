...
public class SteamManager : MonoBehaviour
{
	...
	protected virtual void OnEnable()
	{
		...
		SteamEvents.OnSteamworksError += Event_OnSteamworksError;
	...
	private void Event_SteamOverlaySet(bool b, SteamService steamService)
	{

	}

	private void Event_SteamworksConnected(bool steamService)
	{
	...
	private void Event_OnLeaderboardResult(List<LeaderboardEntry> m_Leaderboard, LEVEL_ID levelID)
	{
	...
	private void Event_OnSteamworksError(string error)
	{
